...
// --------------------------------------------------
#[test]
fn dies_bad_bytes() -> Result<(), Box<dyn Error>> {
...
// --------------------------------------------------
#[test]
fn dies_bad_lines() -> Result<(), Box<dyn Error>> {
    let bad = random_string();
    let expected = format!(
...
// --------------------------------------------------
#[test]
fn dies_bytes_and_lines() -> Result<(), Box<dyn Error>> {
...
#[test]
fn multiple_files_n4() -> Result<(), Box<dyn Error>> {
    run(
...
#[test]
fn multiple_files_c1() -> Result<(), Box<dyn Error>> {
    run(
...
#[test]
fn multiple_files_c2() -> Result<(), Box<dyn Error>> {
    run(
...
#[test]
fn multiple_files_c4() -> Result<(), Box<dyn Error>> {
    run(
